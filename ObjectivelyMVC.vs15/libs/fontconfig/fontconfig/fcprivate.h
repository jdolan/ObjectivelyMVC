...
#define FcPatternVapBuild(result, orig, va)                                    \
    {                                                                          \
        ...
        if (!__p__) {                                                          \
            ...
            if (!__p__) goto _FcPatternVapBuild_bail0;                         \
        }                                                                      \
        for (;;) {                                                             \
    ...
    _FcPatternVapBuild_bail1:                                                  \
        if (!orig) FcPatternDestroy(__p__);                                    \
...
#define FcObjectSetVapBuild(__ret__, __first__, __va__)                        \
    {                                                                          \
        ...
        if (!__os__) goto _FcObjectSetVapBuild_bail0;                          \
        __ob__ = __first__;                                                    \
        while (__ob__) {                                                       \
    ...
    _FcObjectSetVapBuild_bail1:                                                \
        if (!__ret__ && __os__) FcObjectSetDestroy(__os__);                    \
