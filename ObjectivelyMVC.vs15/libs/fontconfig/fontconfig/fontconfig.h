...
FcPublic FcBool
FcConfigSubstitute(FcConfig *config, FcPattern *p, FcMatchKind kind);
...
/* fcfreetype.c */
FcPublic FcPattern *FcFreeTypeQuery(const FcChar8 *file, int id,
...
FcPublic FcBool
FcUtf8Len(const FcChar8 *string, int len, int *nchar, int *wchar);
