...
/**
 * @brief InletBinding for InletTypeRect.
 */
static void bindRect(const Inlet *inlet, ident obj) {
		...
		if (obj) {
			...
			switch (inlet->type) {
				...
				case InletTypeCharacters:
					bindCharacters(inlet, obj);
					break;
				case InletTypeColor:
					bindColor(inlet, obj);
					break;
				case InletTypeDouble:
					bindDouble(inlet, obj);
					break;
				case InletTypeFloat:
					bindFloat(inlet, obj);
					break;
				...
				case InletTypeSubviews:
					bindSubviews(inlet, obj);
					break;
				case InletTypeView:
					bindView(inlet, obj);
					break;
				case InletTypeApplicationDefined:
					bindApplicationDefined(inlet, obj);
					break;
			}
		}
...
static View *viewWithDictionary(const Dictionary *dictionary, Outlet *outlets) {
	...
	bindView(&inlet, (ident) dictionary);
